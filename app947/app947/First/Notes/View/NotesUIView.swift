            ...
            if editNote {
                ZStack {
                    ...
                    if let selectedNote = selectedNote {
                        EditNote(newMemory: $editNote, viewModel: viewModel, noteOne: .constant(selectedNote))
                            .transition(.move(edge: .bottom))
                    }
                }
            }
    ...
    var body: some View {
        VStack {
            ...
            ZStack {
                    ...
                    HStack {
                        ...
                        Button {
                            if !name.isEmpty, !location.isEmpty {
                                    ...
                                    viewModel.editNote(noteOne, image: selectedImage, name: name, location: location, date: date, note: note)
                ...
                .onAppear {
                    selectedImage = noteOne.image
                    name = noteOne.name
                    location = noteOne.location
                    date = noteOne.date
                    note = noteOne.note
